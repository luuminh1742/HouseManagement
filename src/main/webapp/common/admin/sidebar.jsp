...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="" class="brand-link"> <img
		...
		style="opacity: .8"> <span class="brand-text font-weight-light">Quản
			lý nhà</span>
	</a>
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li class="nav-item menu-open"><a
					href='<c:url value="/admin"/>' class="nav-link active"> <i
				...
				<li class="nav-item"><a class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href='<c:url value="/admin/housemanagement"/>'
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Danh sách nhà</p>
						</a></li>
						 
						 <c:forEach var="item" items="${houses.listResult}">
						 	<li class="nav-item"><a href='<c:url value="/admin/house/room?type=manager&houseId=${item.id}&page=1"/>'
				...
				<li class="nav-item"><a
					href='<c:url value="/admin/profile?type=info"/>' class="nav-link">
