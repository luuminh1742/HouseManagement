            ...
            <div class="card card-outline card-primary">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#inforuser" data-toggle="tab">Thông tin tài khoản</a></li>
                  <li class="nav-item"><a class="nav-link" href="#update-infor" data-toggle="tab">Cập nhật thông tin</a></li>
									...
									<div class="col-xs-12 col-sm-8">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<div class="input-group">
													<input class="form-control" type="text"
														name="fullName" placeholder="Tên hiển thị"
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<div class="input-group">
								                    ...
								                    name="birth" type="text" value="${USERMODEL.birth}">
								                  </div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<label class="inline"> <input name="gender"
													type="radio" class="ace" id="male"
													<c:if test="${USERMODEL.gender == 'Nam'}">checked</c:if>>
													<span class="lbl middle"> Nam</span>
												</label> &nbsp; &nbsp; &nbsp; <label class="inline"> <input
													name="gender" type="radio" class="ace" id="female"
													<c:if test="${USERMODEL.gender == 'Nữ'}">checked</c:if>>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<div class="input-group">
								                    ...
								                    <input type="text" class="form-control" data-mask="" inputmode="text"
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
								                    ...
								                    <input type="text" class="form-control" data-mask="" inputmode="text"
								                     value="${USERMODEL.address}" id="form-field-username" placeholder="Địa chỉ"
													name="address">
								                  </div>
