...
<body>
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="font-weight-bold text-danger">Thông tin nhà</h1>
				</div>
				<div class="col-sm-6">
			...
			<div class="card card-outline card-primary" style="padding: 20px;">
				<div class="card-header pull-right">
					...
					<a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
						data-toggle="tooltip" title='Sửa thông tin nhà' href='<c:url value='
						/admin/inforhouse?type=edit&id=${model.id}' />'>
