...
<head>
	<meta charset="UTF-8">
	<title>
		<c:if test="${empty model.id}">Thêm nhà</c:if>
		<c:if test="${not empty model.id}">Chỉnh sửa thông tin nhà</c:if>
	</title>
</head>
...
<body>
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="font-weight-bold text-danger">Chỉnh sửa thông tin nhà</h1>
				</div>
				<div class="col-sm-6">
					...
					<div class="form-group">
						<div class="col-sm-12">
							...
							<c:if test="${empty model.id}">
								<input type="button" class="btn btn-white btn-warning btn-bold" value="Thêm nhà"
									id="btnAddOrUpdateInfoHouse" />
							</c:if>
