			...
			<form id="form-profile">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<div class="custom-control custom-radio">
							<input type="radio" class="custom-control-input" id="genderMale" name="gender" disabled
						...
						<!-- Default checked -->
						<div class="custom-control custom-radio">
							<input type="radio" class="custom-control-input" id="genderFemale" name="gender" disabled
								<c:if test="${model.gender == 'Nữ'}">checked</c:if>> <label class="custom-control-label"
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right">Số
						điện thoại</label>
					<div class="col-sm-9">
						<input class="form-control" type="text" id="phone" name="phone" value="${model.phone}" disabled>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<input type="button" class="btn btn-white btn-warning btn-bold" value="Cập nhật mật khẩu"
							id="btnChangePassword" />
						<input type="reset" class="btn btn-white btn-warning btn-bold" value="Đặt lại" />
					</div>
				</div>
